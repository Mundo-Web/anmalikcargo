...
import CoreValuesRest from "../actions/Admin/CoreValuesRest";

const coreValuesRest = new CoreValuesRest();
...
const CoreValues = () => {
    ...
    const onModalSubmit = async (e) => {
        ...
        const result = await coreValuesRest.save(formData);
        if (!result) return;
    ...
    const onVisibleChange = async ({ id, value }) => {
        const result = await coreValuesRest.boolean({
            id,
            field: "visible",
            value,
        });
    ...
    const onDeleteClicked = async (id) => {
        ...
        const result = await coreValuesRest.delete(id);
        if (!result) return;
        $(gridRef.current).dxDataGrid("instance").refresh();
    };
